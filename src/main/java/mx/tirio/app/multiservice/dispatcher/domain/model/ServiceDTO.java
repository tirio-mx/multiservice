...
public class ServiceDTO extends BaseRecordDTO {
	 ...
	 */
	@Builder
	public ServiceDTO(final Integer id, final String key, final String hash, final ServiceTypeDTO serviceType,
			final String name, final String descripcion, final Date creationDate, final String creationUser,
			final short status) {
